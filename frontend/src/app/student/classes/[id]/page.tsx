    ...
    <div className="min-h-screen bg-gray-100 py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <DashboardHeader title={classDetails.name} userName={currentUser?.name} />
          <Link href="/student/dashboard" className="text-blue-500 hover:text-blue-700">
            Back to Dashboard
          </Link>
        </div>
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden mb-6">
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold mb-2">Started On</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p>Access lectures, notes, and resources</p>
              </Link>
              <Link 
